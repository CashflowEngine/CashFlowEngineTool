...
def page_portfolio_builder(full_df):
    ...
    # === VISUALIZATION TABS (Contents wrapped in cards) ===
    ...
    with viz_tab1:
        with st.container(border=True):
            ...
            fig_eq.update_layout(xaxis_title=None, yaxis_title="Equity", template="plotly_white")
        ...
        with st.container(border=True):
            ...
            fig_dd.update_layout(xaxis_title=None, yaxis_title="Drawdown ($)", template="plotly_white")
    ...
    with viz_tab3:
        with st.container(border=True):
            ...
            fig_margin = px.area(x=port_margin.index, y=port_margin.values)
            fig_margin.update_layout(xaxis_title=None, yaxis_title="Margin ($)", template="plotly_white")
